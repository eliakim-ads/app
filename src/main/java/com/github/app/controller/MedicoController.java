...
public class MedicoController {
    ...
    public List<DadosListagemMedico> listar(){
        ...
        //findAll() -> Médoto que retorna uma lista de objetos do tipo DadosListagemMedico;

        //stream()-> Método utilizado para tranformar a lista em um fluxo de dados, permitindo aplicar operações de tranformação.
        
        //map()-> Método utilizado par a converter cada objeto do tipo médio em um json DadoslistagemMedico, ultizando o constructor que criamos em DadosListagemMedico. 
        
        //tolist()-> Método utlizado para coletar os resultados em uma nova lista do tipo DadosListagemMedico, que é o formato que queremo retornar para API.
    }
    @GetMapping 
